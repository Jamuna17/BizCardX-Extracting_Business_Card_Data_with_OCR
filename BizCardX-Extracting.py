...
icon = Image.open("D:/BizcardX_project/icon.png")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Jamunadevi",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Jamunadevi*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://free4kwallpapers.com/uploads/originals/2015/07/18/red-background-images-png.png");
...
if selected == "Home":
    ...
    with col2:
        st.image("D:/BizcardX_project/ocr image.jpg")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join("C:/Users/JAMUNA/uploaded_cards",uploaded_card.name), "wb") as f:
